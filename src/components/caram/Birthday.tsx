  ...
  return (
    <Reveal as="section" id="cumpleanos" className="py-16 lg:py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        <div className="overflow-hidden rounded-4xl bg-card text-card-foreground shadow-card border border-border">
          <div className="grid gap-0 lg:grid-cols-2">
            <div className="p-7 sm:p-10 lg:p-12 flex flex-col justify-between">
              <div>
                ...
                <div className="mt-8 grid gap-6 sm:grid-cols-2">
                  {items.map((item, idx) => (
                    <Reveal key={item.title} delay={150 + idx * 80} className="flex min-w-0 gap-3">
            ...
            <Reveal delay={200} className="min-h-64 lg:min-h-full">
              <img
                src={birthday}
